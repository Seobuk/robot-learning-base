...
현재 설치(28개): **karpathy-guidelines**, **ponytail** 세트(-audit/-debt/-gain/-help/-review), **superpowers** 세트(brainstorming, systematic-debugging, test-driven-development, using-git-worktrees 등), **ui-ux-pro-max** 세트(design, ui-styling, slides 등). 각 스킬의 SKILL.md가 트리거를 정의한다.
